...
- Anthropic `/v1/messages` and MCP (the rest of the original v1 R34 deferral). LAN binding + bearer auth for the proxy shipped (see Proxy above); **TLS** for the LAN-exposed proxy is the remaining piece and stays deferred.
